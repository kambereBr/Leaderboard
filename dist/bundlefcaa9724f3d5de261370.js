...
/* harmony export */   SCORE_END_POINT: () => (/* binding */ SCORE_END_POINT),
/* harmony export */   addAction: () => (/* binding */ addAction),
/* harmony export */   getAllScore: () => (/* binding */ getAllScore)
/* harmony export */ });
...
var SCORE_END_POINT = 'https://us-central1-js-capstone-backend.cloudfunctions.net/api/games/VbApWvk1ousySFVD8bXJ/scores/';
...
// Get All Score
var getAllScore = /*#__PURE__*/function () {
  var _ref2 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee2(htmlElement) {
    return _regeneratorRuntime().wrap(function _callee2$(_context2) {
      while (1) switch (_context2.prev = _context2.next) {
        case 0:
          _context2.next = 2;
          return fetch(SCORE_END_POINT).then(function (response) {
            return response.json();
          }).then(function (json) {
            (0,_utils_js__WEBPACK_IMPORTED_MODULE_0__["default"])(json.result, htmlElement);
          });
        case 2:
        case "end":
  ...
  return function getAllScore(_x) {
...
var Player = /*#__PURE__*/_createClass(function Player(user, score) {
...
var bodyList = document.getElementById('body-list-score');
var formScore = document.getElementById('form-score');
var inputName = document.getElementById('player-name');
var inputScore = document.getElementById('player-score');
...
formScore.addEventListener('submit', function (e) {
  ...
  if (inputName.value !== '' && inputScore.value !== '') {
    var newPlayer = new _modules_player_js__WEBPACK_IMPORTED_MODULE_2__["default"](inputName.value, inputScore.value);
